 ...
 */
(React => {
  const e = React.createElement; // 1. createElement
  // const virtualDom = e(
  //   'div',
  //   { className: 'parent' },
  //   '我是parent',
  ...
  const virtualDom = /*#__PURE__*/React.createElement("div", {
    className: "parent"
  }, "\u6211\u662Fparent", /*#__PURE__*/React.createElement("div", {
    className: "child"
  }, "\u6211\u662Fchild1"), /*#__PURE__*/React.createElement("div", {
    className: "child"
  }, "\u6211\u662Fchild2"), /*#__PURE__*/React.createElement("div", {
    className: "child"
  }, "\u6211\u662Fchild3"));
  ReactDOM.render(virtualDom, document.querySelector('#root-compiler')); // 2. classComponent, 一定要继承 React.Component, 不然会报错。
  ...
  class VitrualClassComponent extends React.Component {
    render() {
      return /*#__PURE__*/React.createElement("div", null, "VitrualClassComponent");
    }

  }

  ReactDOM.render( /*#__PURE__*/React.createElement(VitrualClassComponent, null), document.querySelector('#root1-compiler')); // 3. functionComponent
  ...
  function VitrualFunctionComponent() {
    return /*#__PURE__*/React.createElement("div", null, "VitrualFunctionComponent");
  }

  ReactDOM.render( /*#__PURE__*/React.createElement(VitrualFunctionComponent, null), document.querySelector('#root2-compiler'));
  /**
