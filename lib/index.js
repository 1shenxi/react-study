...
(React => {
  ...
  class ClassComponent extends React.Component {
    render() {
      ...
      for (let i = 1; i <= this.props.end; i++) {
        LiItems.push( /*#__PURE__*/React.createElement("li", null, i));
      } // INFO: 由此可以看出，对于数组，在 `{}` 中会解析成 DOM 元素


      return /*#__PURE__*/React.createElement("ul", null, LiItems);
    }
  ...
  }), document.querySelector('#root')); // 6.2 key
  ...
  class ClassComponent1 extends React.Component {
    render() {
      ...
      for (let i = 1; i <= this.props.end; i++) {
        ...
        LiItems.push( /*#__PURE__*/React.createElement("li", {
          key: i
        }, i));
      } // INFO: 由此可以看出，对于数组，在 `{}` 中会解析成 DOM 元素
